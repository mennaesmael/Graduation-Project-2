...
<head>
    ...
    <style>
        ...
        *,
        ...
        span {
            animation: moveInPlace 2s infinite;
            font-size: 300%;
            color: red;
        }
    </style>
        ...
        <div class="text-center">
            ...
            <?php if(Route::has('login')): ?>
                <div class=" flex-col items-center mt-6">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="inline-block px-6 py-2 text-white bg-blue-500 rounded-full hover:bg-blue-600 focus:outline-none focus:ring ring-blue-300 focus:ring-offset-2 focus:ring-offset-gray-100 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-offset-gray-800"><?php echo e(__('تسجيل دخول')); ?></a>
...
<?php /**PATH D:\all projects\tasks of gp\laravel\governorate3\resources\views/welcome.blade.php ENDPATH**/ ?>