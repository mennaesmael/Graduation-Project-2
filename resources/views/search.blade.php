...
<body class="bg-gray-200">
    <div class="container mx-auto p-4">
        ...
        <div class="flex items-center justify-between mt-3">
            <a href="{{ route('upload') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">{{ __('الذهاب لصفحة الرفع') }}</a>
            <a href="{{ route('dashboard') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">{{ __('الذهاب للصفحة الرئيسية') }}</a>
        </div>
        ...
        <div class="mt-6">
            ...
            @if (count($files) > 0)
                ...
                <div class="pagination-links">
                    {{ $files->appends(['query' => $file_query, 'user_query' => $user_query])->links() }}
                </div>
            @else
