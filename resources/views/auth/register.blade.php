                        ...
                        <x-guest-layout class="bg-gray-100  ">
                            ...
                            <form method="POST" action="{{ route('register') }}"
                                ...
                                <div class=" ">
                                    ...
                                    <x-text-input id="email" placeholder="يجب ان يكون البريد مسجلا فى gmail"
                                ...
                                <div class="  ">
                                    ...
                                    <x-text-input id="admin" class="block mt-1 w-full bg-gray-100"
                                        placeholder="برجاء الاجابة بنعم او لا" type="text" name="admin"
                                        :value="old('admin')" required autocomplete="admin" />
                                ...
                                <div class=" ">
                                    ...
                                    <x-text-input id="password" class="block mt-1 w-full bg-gray-100" type="password"
                                ...
                                <div class="   ">
                                    ...
                                    <x-text-input id="password_confirmation" class="block mt-1 w-full bg-gray-100"
                                        ...
                                        autocomplete="new-password" placeholder="يجب الا يقل عن 8 احرف او ارقام" />
